...
raw_df=pd.read_excel(SRC, sheet_name="Data_Input", header=3).dropna(how="all").reset_index(drop=True).head(10)
enr_df=pd.read_excel(ENR, sheet_name="Full_Enriched").head(10)
...
out="/home/user/NYU_MSBAi/first_10_venues_filled.xlsx"
...
idx["A1"]="First 10 Venues — Filled & Audited (Index)"; idx["A1"].font=title_font
